...
public class ProductController : ControllerBase
{
    ...
    public async Task<IActionResult> Post()
    {
        var newProductModel = new ProductModel
        {
            ...
            ImgUrl =
                "https://www.pluralsight.com/content/dam/pluralsight2/teach/author-tools/carved-rock-fitness/img-greyboots.jpg",
            Name = "OLD AND TIRED",
            Price = 99.99
        };
    ...
    public async Task<IActionResult> Put()
    {
        var newProductModel = new ProductModel
        {
            ...
            ImgUrl =
                "https://www.pluralsight.com/content/dam/pluralsight2/teach/author-tools/carved-rock-fitness/img-brownboots.jpg",
